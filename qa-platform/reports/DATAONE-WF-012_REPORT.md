...
| DATAONE-TC290 | The shipment email is routed by order type, with the Delivery Slip att | P2 | AUTOMATED | NOT_RUN | FAIL | NOT_COMPARED |
...
- **DATAONE-TC290** [Odoo 19 → FAIL / ASSERTION] unresolved shipment xmlids: expected [], got ['dto_sale_stock.base_automation_send_email_on_sale_order_shipped', 'dto_sale_stock.action_server_send_email_on_sale_order_shipped', 'dto_sale_stock.mail_template_delivery_validated']
