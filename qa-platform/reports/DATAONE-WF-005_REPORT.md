...
- Odoo 19: PASS 0 / FAIL 0 / BLOCKED 0 / not executed 4
...
|---|---|---|---|---|---|---|
| DATAONE-TC058 | Decimal precision records, including the 'Product Unit of Measure' ren | P1 | AUTOMATED | NOT_RUN | SKIPPED | NOT_COMPARED |
| DATAONE-TC101 | Assigning an MO Operation Type generates one work order per line | P1 | AUTOMATED | NOT_RUN | SKIPPED | NOT_COMPARED |
| DATAONE-TC102 | Changing the operation type destroys the old work orders and regenerat | P0 | AUTOMATED | NOT_RUN | SKIPPED | NOT_COMPARED |
| DATAONE-TC103 | Deleting an operation-type line removes the matching work order from o | P1 | AUTOMATED | NOT_RUN | SKIPPED | NOT_COMPARED |
| DATAONE-TC104 | An operation type referenced by any MO cannot be deleted | P2 | AUTOMATED | NOT_RUN | SKIPPED | NOT_COMPARED |
| DATAONE-TC105 | An MO with no operation type keeps core's BoM-driven routing, and the  | P1 | AUTOMATED | NOT_RUN | SKIPPED | NOT_COMPARED |
