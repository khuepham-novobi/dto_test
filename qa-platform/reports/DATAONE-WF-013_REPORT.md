...
- Odoo 19: PASS 21 / FAIL 9 / BLOCKED 2 / not executed 0
...
- **DATAONE-TC027** [Odoo 19 → FAIL / ASSERTION] No differences vs v17 baseline: expected [], got ['keys_with_1_account(s): baseline=None current=389894', 'keys_with_2_account(s): baseline=None current=136374', 'lines_with_distribution: baseline=0 current=446807']
- **DATAONE-TC028** [Odoo 19 → FAIL / ASSERTION] No differences vs v17 baseline: expected [], got ['journal_items: baseline=84 current=546601', 'with_distribution: baseline=0 current=446807', 'with_distribution/account/197: baseline=None current=28', 'with_distribution/account/208: baseline=None current=1396
- **DATAONE-TC052** [Odoo 19 → FAIL / ASSERTION] No differences vs v17 baseline: expected [], got ['is_cogs/account/197: baseline=None current=-140.0', 'is_cogs/account/208: baseline=None current=-505543.25', 'is_cogs/account/278: baseline=None current=505683.25', 'is_cogs_accounts: baseline=0 current=3', 'i
