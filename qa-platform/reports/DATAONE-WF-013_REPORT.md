...
- **DATAONE-TC007** [Odoo 19 → FAIL / ASSERTION] env.ref() literals that do not resolve: expected {}, got {'base_tier_validation.view_comment_wizard': ['base_tier_validation/models/tier_validation.py:519'], 'location_barcode_labels.barcodelabelslocation': ['location_barcode_labels/wizard/barcode_labels_locat
...
- **DATAONE-TC021** [Odoo 19 → FAIL / ASSERTION] No differences vs v17 baseline: expected [], got ['account/14: baseline=0.0 current=None', 'account/189: baseline=None current=-5420348.88', 'account/19: baseline=0.0 current=None', 'account/190: baseline=None current=-200.0', 'account/197: baseline=None curre
- **DATAONE-TC027** [Odoo 19 → FAIL / ASSERTION] No differences vs v17 baseline: expected [], got ['keys_with_1_account(s): baseline=None current=389898', 'keys_with_2_account(s): baseline=None current=136384', 'lines_with_distribution: baseline=0 current=446821']
- **DATAONE-TC028** [Odoo 19 → FAIL / ASSERTION] No differences vs v17 baseline: expected [], got ['journal_items: baseline=84 current=546741', 'with_distribution: baseline=0 current=446821', 'with_distribution/account/197: baseline=None current=28', 'with_distribution/account/208: baseline=None current=1406
- **DATAONE-TC052** [Odoo 19 → FAIL / ASSERTION] No differences vs v17 baseline: expected [], got ['is_cogs/account/197: baseline=None current=-140.0', 'is_cogs/account/208: baseline=None current=-506143.25', 'is_cogs/account/278: baseline=None current=506283.25', 'is_cogs_accounts: baseline=0 current=3', 'i
...
- **DATAONE-TC272** [Odoo 19 → FAIL / ASSERTION] the deletion succeeded: expected True, got "account.move.unlink failed: You are not allowed to access 'Journal Entry' (account.move) records. | This operation is allowed for the following groups: | - Accounting/Administrator | - Accounting/Invoicing | - Employ
