...
|---|---|---|---|---|---|---|
| DATAONE-TC014 | The five OCA modules import and load on the v19 runtime | P0 | AUTOMATED | FAIL | SKIPPED | NOT_COMPARED |
| DATAONE-TC095 | Gate case: revision -01 created, source cancelled and archived, fields | P1 | AUTOMATED | ERROR | SKIPPED | NOT_COMPARED |
| DATAONE-TC096 | A second revision flattens the chain; the stat button lists all prior  | P1 | AUTOMATED | ERROR | SKIPPED | NOT_COMPARED |
| DATAONE-TC097 | The revision button appears only in sent and cancel | P2 | AUTOMATED | ERROR | SKIPPED | NOT_COMPARED |
| DATAONE-TC098 | The lineage uniqueness constraint and its exact message | P2 | AUTOMATED | ERROR | SKIPPED | NOT_COMPARED |
| DATAONE-TC338 | Re-import of an unconfirmed order creates a revision, cancels and arch | P0 | AUTOMATED | ERROR | SKIPPED | NOT_COMPARED |
...
- **DATAONE-TC095** [Odoo 19 → FAIL / ASSERTION] revision chatter carries the notice: expected True, got "2 message(s); looking for 'New revision created: S06349-01'; bodies=['Sales Order created', 'New revision created from: S06349']"
