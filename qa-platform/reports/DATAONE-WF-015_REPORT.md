...
- Odoo 19: PASS 4 / FAIL 13 / BLOCKED 2 / not executed 1
...
| DATAONE-TC216 | A tracked product without auto_create_lot still requires a manual lot  | P2 | AUTOMATED | NOT_RUN | PASS | NOT_COMPARED |
...
- **DATAONE-TC206** [Odoo 19 → FAIL / ASSERTION] the server message, verbatim: expected 'Cannot update the Expected Arrival date because Product WF015-5F1AB92B TD-P-04 is fully received', got "'purchase.order.line' object has no attribute 'product_uom'"
...
- **DATAONE-TC214** [Odoo 19 → ERROR / AUTOMATION_ERROR] OdooRPCError: quality.check.action_open_quality_check_wizard failed: Expected singleton: quality.check(2521, 2522)
