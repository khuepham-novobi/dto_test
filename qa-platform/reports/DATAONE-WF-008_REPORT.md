...
- Odoo 19: PASS 1 / FAIL 21 / BLOCKED 1 / not executed 0
...
| DATAONE-TC248 | Concurrent-timesheet guard still fires on v19 (the create list canary) | P0 | AUTOMATED | NOT_RUN | FAIL | NOT_COMPARED |
...
- **DATAONE-TC248** [Odoo 19 → FAIL / ASSERTION] identifiers the UserError fails to name: expected {}, got {'employee': 'WF008 E-01 [f2d033]', 'work centre': 'Test-248', 'manufacturing order': 'WH-MO-11793'}
