...
- Manual-only: **1**
- Currently BLOCKED (either environment): **6**
- Odoo 17: PASS 0 / FAIL 0 / BLOCKED 0 / SKIPPED 0 / not executed 23
- Odoo 19: PASS 16 / FAIL 1 / BLOCKED 6 / not executed 0
...
| DATAONE-TC377 | Scrap Entries lists only posted entries whose reference contains SP-,  | P1 | AUTOMATED | NOT_RUN | PASS | NOT_COMPARED |
| DATAONE-TC378 | Orders Completed per Day counts done MOs by finish day and silently ex | P1 | AUTOMATED | NOT_RUN | PASS | NOT_COMPARED |
| DATAONE-TC379 | Cable Assemblies Produced reports quantity by product and week, includ | P1 | AUTOMATED | NOT_RUN | PASS | NOT_COMPARED |
| DATAONE-TC380 | Feet of Cable Cut/Processed reports 50.0 ft in week 2026-W34 for TD-P- | P0 | AUTOMATED | NOT_RUN | PASS | NOT_COMPARED |
| DATAONE-TC381 | Labor hour per assembly totals 180 minutes in week 2026-W34, split 120 | P1 | AUTOMATED | NOT_RUN | BLOCKED | BLOCKED |
| DATAONE-TC382 | Average Assembly Time per Unit is 36.0, becomes 60.0 when an MO is fla | P1 | AUTOMATED | NOT_RUN | PASS | NOT_COMPARED |
| DATAONE-TC383 | MO Actual time is 120.0 and Expected time is 72.0, and Expected does n | P1 | AUTOMATED | NOT_RUN | PASS | NOT_COMPARED |
| DATAONE-TC384 | Time Sheet Report shows the four stored related columns, and the time_ | P1 | AUTOMATED | NOT_RUN | PASS | NOT_COMPARED |
| DATAONE-TC385 | Customer Delivery Report shows only the confirmed, to-invoice order | P1 | AUTOMATED | NOT_RUN | PASS | NOT_COMPARED |
| DATAONE-TC386 | Vendor Delivery Report shows the confirmed and the locked PO — the v19 | P0 | AUTOMATED | NOT_RUN | PASS | NOT_COMPARED |
