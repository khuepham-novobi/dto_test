...
- **DATAONE-TC025** [Odoo 19 → FAIL / ASSERTION] No differences vs v17 baseline: expected [], got ['internal_quant_products: baseline=39 current=1065', 'internal_quant_quantity: baseline=1795.0 current=19150627.11', 'svl_model_present: baseline=None current=False', 'svl_products: baseline=17 current=None', '
- **DATAONE-TC034** [Odoo 19 → FAIL / ASSERTION] No differences vs v17 baseline: expected [], got ["columns_present: baseline='valuation_in_account_id,valuation_out_account_id' current='valuation_account_id'", 'locations: baseline=37 current=358', 'populated/valuation_account_id: baseline=None current=0', 'p
- **DATAONE-TC169** [Odoo 19 → ERROR / AUTOMATION_ERROR] OdooRPCError: product.product.onchange failed: You are not allowed to modify 'Product Variant' (product.product) records. | This operation is allowed for the following groups: | - Products/Create | - Accountant access | - Accountant lock dates | Contact your a
- **DATAONE-TC170** [Odoo 19 → ERROR / AUTOMATION_ERROR] OdooRPCError: product.product.onchange failed: You are not allowed to modify 'Product Variant' (product.product) records. | This operation is allowed for the following groups: | - Products/Create | - Accountant access | - Accountant lock dates | Contact your a
- **DATAONE-TC172** [Odoo 19 → ERROR / AUTOMATION_ERROR] OdooRPCError: product.product.onchange failed: You are not allowed to create 'Product Variant' (product.product) records. | This operation is allowed for the following groups: | - Products/Create | - Accountant access | - Accountant lock dates | Contact your a
- **DATAONE-TC173** [Odoo 19 → ERROR / AUTOMATION_ERROR] OdooRPCError: product.product.onchange failed: You are not allowed to modify 'Product Variant' (product.product) records. | This operation is allowed for the following groups: | - Products/Create | - Accountant access | - Accountant lock dates | Contact your a
