...
| DATAONE-TC177 | v19 detector: the required-level rule must still be enforced after typ | P0 | AUTOMATED | NOT_RUN | PASS | NOT_COMPARED |
...
- **DATAONE-TC025** [Odoo 19 → FAIL / ASSERTION] No differences vs v17 baseline: expected [], got ['internal_quant_products: baseline=39 current=980', 'internal_quant_quantity: baseline=1795.0 current=19150887.11', 'svl_model_present: baseline=None current=False', 'svl_products: baseline=17 current=None', 's
- **DATAONE-TC034** [Odoo 19 → FAIL / ASSERTION] No differences vs v17 baseline: expected [], got ["columns_present: baseline='valuation_in_account_id,valuation_out_account_id' current='valuation_account_id'", 'locations: baseline=37 current=353', 'populated/valuation_account_id: baseline=None current=0', 'p
...
- **DATAONE-TC175** [Odoo 19 → FAIL / ASSERTION] Physical Inventory lists all three quants: expected [190166, 190167, 190168, 190169], got [190167, 190168, 190169]
