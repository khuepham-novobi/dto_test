...
| DATAONE-TC342 | The manual upload wizard produces the same orders — and no sftp.file | P1 | AUTOMATED | NOT_RUN | FAIL | NOT_COMPARED |
...
- **DATAONE-TC342** [Odoo 19 → FAIL / ASSERTION] the wizard did not raise: expected True, got '\'sale.order.import_workday_requisition.import_requisition failed: Unsupported file format "application/octet-stream", import only supports CSV, ODS, XLS and XLSX\''
